...
function [t, movements, Best, AverageSolution, LastValueOf_N, trajectoryFlies] = Firefly_Algorithm(PopulationSize, NumMovements, Alpha, Beta0, Gamma, Theta, Dimension, optimiser, graphs, checkRadius)
    %% Firefly Algorithm
    ...
    if graphs == 2
        gif_filename = 'firefly_algorithm.gif';  % name for the GIf
       ...
       for i = 1:PopulationSize
          ...
          for j = 1:PopulationSize
             ...
             if Fitness(i,1)>=Fitness(j,1) %Brigther/more attractive
                 ...
                 [NewFitness, ~] = optimisation_functions(Position(1), Position(2), optimiser, "Optimiser");
          ...
          checkError = breakCheck(Population(i,1), Population(i,2), optimiser, checkRadius);
          N = N + checkError;
       end
